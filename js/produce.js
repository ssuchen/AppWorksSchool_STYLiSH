...
function productrender(data) {
  ...
  productClothesQuantityform.setAttribute(
    "class",
  ...
  productCenterContentBottom.setAttribute(
    "class",
  ...
  for (let c = 0; c < colorlen; c++) {
    ...
    Colortext +=
      "<li class='product-clothes-color'color='" +
      colorCode +
      "'colorname='" +
      colorName +
...
function productAjax(text) {
  let productApi =
    "https://api.appworks-school.tw/api/1.0/products/details?id=" + text;
  return productApi;
}
